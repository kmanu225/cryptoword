...
- **Projective**: Basically, this refers to the perspective of an object in a defined space. For example, a line is sean as straight in Euclidean space, while a circle appears round.
- **Algebraic**: The curve consists of points that satisfy a polynomial equation.  
- **Specified point \( O \)**: This is the point at infinity the curve is a projection. 

<center>
<p>
    <img src="./ressources/image-2.png" alt="Elliptic Curve">
</p>
<p>
    <em>Fig 1: Smooth curves—curves without singularities.</em>
</p>
</center>
